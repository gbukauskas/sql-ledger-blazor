    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("mimetype_pkey", x => x.extension);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    onhand = table.Column<decimal>(type: "decimal(28,6)", precision: 28, scale: 6, nullable: false, defaultValue: 0m),
                    notes = table.Column<string>(type: "nvarchar(MAX)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    customer_id = table.Column<int>(type: "int", nullable: true),
                    pricegroup_id = table.Column<int>(type: "int", nullable: true),
                    pricebreak = table.Column<decimal>(type: "decimal(28,6)", precision: 28, scale: 6, nullable: true),
                    sellprice = table.Column<decimal>(type: "decimal(28,6)", precision: 28, scale: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR public_id"),
                    partsgroup = table.Column<string>(type: "nvarchar(4000)", nullable: true),
                    pos = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false),
                    trans_id = table.Column<int>(type: "int", nullable: false),
                    exchangerate = table.Column<double>(type: "float", nullable: true, defaultValue: 1.0),
                    paymentmethod_id = table.Column<int>(type: "int", nullable: true),
                    row_version = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR public_id"),
                    description = table.Column<string>(type: "nvarchar(MAX)", nullable: true),
                    fee = table.Column<decimal>(type: "decimal(28,6)", precision: 28, scale: 6, nullable: true),
                    rn = table.Column<short>(type: "smallint", nullable: true),
                    roundchange = table.Column<double>(type: "float", nullable: true),
                    row_version = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR public_id"),
                    pricegroup = table.Column<string>(type: "nvarchar(4000)", nullable: true),
                    row_version = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR public_id"),
                    projectnumber = table.Column<string>(type: "nvarchar(4000)", nullable: true),
                    description = table.Column<string>(type: "nvarchar(MAX)", nullable: true),
                    startdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    enddate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    parts_id = table.Column<int>(type: "int", nullable: true),
                    production = table.Column<decimal>(type: "decimal(28,6)", precision: 28, scale: 6, nullable: false, defaultValue: 0m),
                    completed = table.Column<decimal>(type: "decimal(28,6)", precision: 28, scale: 6, nullable: false, defaultValue: 0m),
                    customer_id = table.Column<int>(type: "int", nullable: true),
                    row_version = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("project_id_key", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    enddate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    repeat = table.Column<short>(type: "smallint", nullable: true),
                    unit = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true),
                    howmany = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR reference_id"),
                    code = table.Column<string>(type: "nvarchar(MAX)", nullable: true),
                    trans_id = table.Column<int>(type: "int", nullable: true),
                    description = table.Column<string>(type: "nvarchar(MAX)", nullable: true),
                    archive_id = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("reference_pkey", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    reportid = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR public_id"),
            ...
            migrationBuilder.CreateIndex(
                name: "partscustomer_customer_id_key",
                table: "partscustomer",
                column: "customer_id");

            migrationBuilder.CreateIndex(
                name: "partscustomer_parts_id_key",
                table: "partscustomer",
                column: "parts_id");

            migrationBuilder.CreateIndex(
                name: "partsgroup_id_key",
                table: "partsgroup",
                column: "id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "partstax_parts_id_key",
                table: "partstax",
                column: "parts_id");

            migrationBuilder.CreateIndex(
                name: "partsvendor_parts_id_key",
                table: "partsvendor",
                column: "parts_id");

            migrationBuilder.CreateIndex(
                name: "partsvendor_vendor_id_key",
                table: "partsvendor",
                column: "vendor_id");

            migrationBuilder.CreateIndex(
                name: "pricegroup_id_key",
                table: "pricegroup",
                column: "id");

            migrationBuilder.CreateIndex(
                name: "pricegroup_pricegroup_key",
                table: "pricegroup",
                column: "pricegroup");

            migrationBuilder.CreateIndex(
                name: "projectnumber_key",
                table: "project",
